...
from aircraft_anomaly_detection.preprocessing import CLIPBackgroundRemover
...
def main(args):
    ...
    if args.input.lower() in get_args(DatasetString) or args.input.lower() == "all":
        ...
        evaluate(AnomalyDataset(args.input.lower(), category), model, args.output_path, background_remover)
